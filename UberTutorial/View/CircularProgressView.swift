...
//  UberTutorial
//
//  Created by Rafaela Torres Alves Ribeiro Galdino on 28/06/21.
//
...
class CircularProgressView: UIView {
    ...
    private func circleShapeLayer(strokeColor: UIColor, fillColor: UIColor) -> CAShapeLayer {
        ...
        let circularPth = UIBezierPath(arcCenter: center, radius: self.frame.width / 2.6, startAngle: -(.pi / 2), endAngle: 1.5 * .pi, clockwise: true)
        
        layer.path = circularPth.cgPath
